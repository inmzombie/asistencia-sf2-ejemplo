...
namespace Ipap\Ejemplo\AsistenciaBundle\Controller;
...
use Ipap\Ejemplo\AsistenciaBundle\Entity\Alumno;
use Ipap\Ejemplo\AsistenciaBundle\Form\AlumnoType;
use Ipap\Ejemplo\AsistenciaBundle\Form\AlumnoFilterType;
...
class AlumnoController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('IpapEjemploAsistenciaBundle:Alumno')
        ...
        if ($filterForm->get('reset')->isClicked()) {
            $session->remove('AlumnoControllerFilter');
            $filterForm = $this->createFilterForm();
        }
        ...
        if ($filterForm->get('filter')->isClicked()) {
            if ($filterForm->isValid()) {
                ...
                $session->set('AlumnoControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('AlumnoControllerFilter')) {
                $filterData = $session->get('AlumnoControllerFilter');
    ...
    */
    ...
    {
        $form = $this->createForm(new AlumnoFilterType(), $filterData, array(
            'action' => $this->generateUrl('alumno'),
            'method' => 'GET',
        ));
     ...
     * @Method("POST")
     * @Template("IpapEjemploAsistenciaBundle:Alumno:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('alumno_new')
                    : $this->generateUrl('alumno_show', array('id' => $entity->getId()));
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IpapEjemploAsistenciaBundle:Alumno')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IpapEjemploAsistenciaBundle:Alumno:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('alumno_new')
                        : $this->generateUrl('alumno_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
